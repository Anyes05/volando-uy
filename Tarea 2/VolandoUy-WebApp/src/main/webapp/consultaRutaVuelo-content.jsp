<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <div class="contenido-principal">
      <section class="search-box">
        <div class="search-header">
          ...
          <p class="descripcion-consulta">Explora las rutas de vuelo disponibles y encuentra la conexión perfecta para
            tu próximo viaje. Todas las rutas mostradas están confirmadas y operativas.</p>
        </div>
    ...
    <style>
      ...
      /* Estilos para el panel de detalles de ruta (Video) */
      ...
      .ruta-video-container {
        background: rgba(34, 152, 202, 0.1);
        border: 1px solid rgba(34, 152, 202, 0.2);
        border-radius: 12px;
        padding: 10px;
