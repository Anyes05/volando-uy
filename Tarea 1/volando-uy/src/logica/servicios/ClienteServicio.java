...
public class ClienteServicio {
    ...
    public void crearCliente(String nickname, String nombre, String correo,
                             ...
                             String numeroDocumento, byte[] foto) throws Exception {
    ...
    public void precargarClientes() {
        try {
            ...
            Object[][] clientesData = {
                    // {nickname, nombre, correo, apellido, dia, mes, año, nacionalidad, tipoDoc, numeroDoc, foto}
                    {"jperez", "Juan", "juan.perez@email.com", "Pérez", 15, 3, 1990, "Uruguaya", TipoDoc.CI, "12345678", null},
                    {"mgarcia", "María", "maria.garcia@email.com", "García", 22, 7, 1985, "Argentina", TipoDoc.PASAPORTE, "AB123456", null},
                    {"rlopez", "Roberto", "roberto.lopez@email.com", "López", 8, 12, 1992, "Brasileña", TipoDoc.CI, "87654321", null},
                    {"acastro", "Ana", "ana.castro@email.com", "Castro", 3, 5, 1988, "Chilena", TipoDoc.PASAPORTE, "CD789012", null},
                    {"fmartinez", "Fernando", "fernando.martinez@email.com", "Martínez", 18, 9, 1995, "Uruguaya", TipoDoc.CI, "11223344", null},
                    {"srodriguez", "Sofía", "sofia.rodriguez@email.com", "Rodríguez", 25, 11, 1991, "Paraguaya", TipoDoc.PASAPORTE, "EF345678", null},
                    {"dfernandez", "Diego", "diego.fernandez@email.com", "Fernández", 12, 2, 1987, "Argentina", TipoDoc.CI, "55667788", null},
                    {"lgonzalez", "Laura", "laura.gonzalez@email.com", "González", 30, 6, 1993, "Uruguaya", TipoDoc.CI, "99887766", null},
                    {"chernandez", "Carlos", "carlos.hernandez@email.com", "Hernández", 7, 4, 1989, "Brasileña", TipoDoc.PASAPORTE, "GH901234", null},
                    {"mruiz", "Mónica", "monica.ruiz@email.com", "Ruiz", 14, 8, 1994, "Chilena", TipoDoc.CI, "44556677", null},
            };
